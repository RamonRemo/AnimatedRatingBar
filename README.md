...
4. There others parameters you can change to personalize your ratingbar like animation intensity, rating widget. You can recover the rating value using the callback method
